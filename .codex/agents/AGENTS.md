...
- Keep only agent-specific behavior here. Do not duplicate the whole root contract.
...
- These files are a working routing layer for recon, security review, docs verification, browser evidence, and targeted fixes.
